...
class S {
  ...
  /// `Layers`
  String get layers {
    return Intl.message('Layers', name: 'layers', desc: '', args: []);
  }

  /// `Add layer`
  String get addLayer {
    return Intl.message('Add layer', name: 'addLayer', desc: '', args: []);
  }
  ...
  String get layerName {
    return Intl.message('Layer name', name: 'layerName', desc: '', args: []);
  }
  ...
  /// `Color & thickness`
  String get colorAndThickness {
    return Intl.message(
      'Color & thickness',
      name: 'colorAndThickness',
      desc: '',
      args: [],
    );
  }
  ...
  String pdfExportedTo(Object path) {
    return Intl.message(
      'PDF exported to $path',
      name: 'pdfExportedTo',
      desc: '',
  ...
  /// `Could not set PDF background: {error}`
  String couldNotSetPdfBackground(Object error) {
    return Intl.message(
      'Could not set PDF background: $error',
      name: 'couldNotSetPdfBackground',
      desc: '',
      args: [error],
    );
  }

  /// `Could not set image background: {error}`
  String couldNotSetImageBackground(Object error) {
    return Intl.message(
      'Could not set image background: $error',
      name: 'couldNotSetImageBackground',
      desc: '',
      args: [error],
    );
  }
  ...
  /// `PDF page`
  String get pdfPage {
    return Intl.message('PDF page', name: 'pdfPage', desc: '', args: []);
  }

  /// `Page number`
  String get pageNumber {
    return Intl.message('Page number', name: 'pageNumber', desc: '', args: []);
  }

  /// `Whiteout`
  String get whiteout {
    return Intl.message('Whiteout', name: 'whiteout', desc: '', args: []);
  }
}
