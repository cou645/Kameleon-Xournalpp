...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m0(error) => "Could not set image background: ${error}";

  static String m1(error) => "Could not set PDF background: ${error}";

  static String m2(error) => "PDF export failed: ${error}";

  static String m3(path) => "PDF exported to ${path}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "addLayer": MessageLookupByLibrary.simpleMessage("Add layer"),
    ...
    "colorAndThickness": MessageLookupByLibrary.simpleMessage(
      "Color & thickness",
    ),
    ...
    "layerName": MessageLookupByLibrary.simpleMessage("Layer name"),
    ...
    "manageLayers": MessageLookupByLibrary.simpleMessage("Manage Layers"),
    ...
    "pdfExportFailed": m2,
    "pdfExportedTo": m3,
    "pdfPage": MessageLookupByLibrary.simpleMessage("PDF page"),
    ...
    "renameLayer": MessageLookupByLibrary.simpleMessage("Rename layer"),
    "renderingPdf": MessageLookupByLibrary.simpleMessage("Rendering PDF…"),
    ...
    "whiteout": MessageLookupByLibrary.simpleMessage("Whiteout"),
